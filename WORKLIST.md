...
- [ ] **ACTIVE — Continuity patch exact-main Mac commissioning:** product exact-main `6d2fcd923e8fa0417a2e7787acd0dcef6b25e544` → rebuild preflight → exact-SHA rebuild/install → runtime/app provenance → source/runtime parity. This is the required prerequisite for live restart/resume evidence.
