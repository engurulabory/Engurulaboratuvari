...
- [ ] **ACTIVE — Checkpoint / runtime restart / same-task resume field proof:** canonical task `ENGURU-V06-FIELD-001` + checkpoint `v06-field-cp-001` → restart runtime → resume same canonical task → verify same reliability task / duplicate+recovered semantics → regression → Evidence → promote real Mac task to 6/7 only on PASS.
