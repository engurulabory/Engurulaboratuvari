...
V07-A03 + V07-A04 **PASS / exact-main verified**: Product PR #10 → `1dcbc795e4b949448206fbad93b239aca297cc0f`; Product CI #21 PASS / 50 tests OK.

V07-A05 + V07-A06 **PASS / exact-main verified**: Product PR #11 → current product main `199893b07941a82c26c3b39a7942478cb95420b0`; Product CI #23 PASS / 52 tests OK. Canonical Evidence: `evidence/MAC_ENGINEER_V07_A03_A06_ENGINEERING_2026-09-22.md`.

Current required difference: implement and verify `V07-A07 + V07-A08 → RESOURCE_DISCIPLINE_AND_EVIDENCE_CONTINUITY`.
...
`V0_7_LONG_RUNNING_RELIABILITY → V07-A07 + V07-A08 → RESOURCE_DISCIPLINE_AND_EVIDENCE_CONTINUITY → GITHUB_FIRST_ENGINEERING`
